Dataset: PKGE71FL
Displacement Restriction: District (Admin 3)
...
Restricted to admin3:
The displacement is restricted so that the points stay within the country, within the DHS survey region, and within
the admin3 area. Therefore, the displaced cluster's coordinates are located within the same admin0, admin1,
and admin3 areas as the undisplaced cluster.
